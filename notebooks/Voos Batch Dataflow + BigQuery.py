...
pipeline_options = {
    ...
    'template_location': 'gs://apache_beam_voos/template/batch_job_df_gcs_big_query',
...
tabela = 'dataflow-beam-voos:dataflow-beam-voos.dataflow_voos.voos_atraso'

Tempo_Atrasos = (
    p1
    | "Importar Dados Atraso" >> beam.io.ReadFromText(r"gs://apache_beam_voos/entrada/voos_sample.csv", skip_header_lines=1)
...
Qtd_Atrasos = (
    p1
    | "Importar Dados" >> beam.io.ReadFromText(r"gs://apache_beam_voos/entrada/voos_sample.csv", skip_header_lines=1)
...
tabela_atrasos = (
    ...
    | beam.io.WriteToBigQuery(
        ...
        custom_gcs_temp_location='gs://apache_beam_voos/temp')
